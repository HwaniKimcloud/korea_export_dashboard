...
with tab_product_country:
    ...
    st.markdown(
        """
        <div class="section-note">
        품목별 주요 수출시장과 선택 국가의 수출 모멘텀을 함께 추적.
        YTD 수출액, 국가별 비중, 시장 집중도와 국가 내 품목 비중을 함께 확인.
        </div>
        """,
        unsafe_allow_html=True,
    )
    ...
    if product_country_monthly.empty:
        ...
        # CSV 저장 과정에서 생길 수 있는 BOM / 공백 / zero-width 문자 제거
        pc.columns = (
            pc.columns
            .astype(str)
            .str.replace(
        ...
        if missing_required:
            ...
            st.caption(
                "컬럼 매핑 진단 → "
                f"품목={product_col} | HS={hs_col} | 국가={pc_country_col} | "
                f"기준월={pc_date_col} | USD={pc_usd_col} | bn={pc_bn_col}"
            )
            ...
            def normalize_hs_display(value):
            ...
            if filtered_products.empty:
                ...
                # ============================================
                # 18-6. PRODUCT-LEVEL YTD / MARKET MASTER
                # ============================================
                ...
                if not country_candidates:
                    ...
                    # ========================================
                    # 18-8. COUNTRY × PRODUCT MONTHLY SERIES
                    # ========================================
                    ...
                    # ========================================
                    # 18-9. SELECTED COUNTRY TOTAL EXPORT YTD
                    # ========================================
                    ...
                    # ========================================
                    # 18-14. PRODUCT MARKET STRUCTURE
                    # ========================================
                    ...
                    st.markdown(
                        ...
                        <div class="section-note">
                        YTD 기준 주요 수출국 순위.
                        막대 안쪽은 국가별 YTD 수출액, 바깥 숫자는 해당 품목의 전체 YTD 수출에서 차지하는 비중.
                        </div>
                        """,
                        unsafe_allow_html=True,
                    )
                    ...
                    st.markdown(
                        ...
                        선택한 {selected_pc_country}는
                        해당 품목 수출의 <b>{selected_market_share:.1f}%</b>를 차지하며
...
st.markdown(
    ...
    Product × Country: Korea Customs Service HS-based monthly export data.<br>

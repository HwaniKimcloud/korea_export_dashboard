...
def get_all_product_country_data(start_yymm, end_yymm):
...
print()
print("=" * 70)
print(f"{PRODUCT_NAME} 전체 국가 데이터 수집")
print("=" * 70)

df_2025 = get_all_product_country_data(
    "202501",
    "202512"
)

df_2026 = get_all_product_country_data(
    "202601",
    "202608"
)
...
if not all_data:
    raise Exception("수집된 품목×국가 데이터가 없습니다.")
...
raw.to_csv(
    "product_country_raw_8542.csv",
    index=False,
    encoding="utf-8-sig"
)

monthly.to_csv(
    "product_country_monthly_8542.csv",
    index=False,
    encoding="utf-8-sig"
)

latest.to_csv(
    "product_country_latest_8542.csv",
    index=False,
    encoding="utf-8-sig"
)

latest_top10.to_csv(
    "product_country_latest_top10_8542.csv",
    index=False,
    encoding="utf-8-sig"
)

ytd.to_csv(
    "product_country_ytd_8542.csv",
    index=False,
    encoding="utf-8-sig"
)

ytd_top10.to_csv(
    "product_country_ytd_top10_8542.csv",
    index=False,
    encoding="utf-8-sig"
)
...
print("- product_country_raw_8542.csv")
print("- product_country_monthly_8542.csv")
print("- product_country_latest_8542.csv")
print("- product_country_latest_top10_8542.csv")
print("- product_country_ytd_8542.csv")
print("- product_country_ytd_top10_8542.csv")